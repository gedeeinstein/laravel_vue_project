...
class CreateMasLotResidentialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mas_lot_residentials', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('pj_lot_residential_a_id')->nullable();
            $table->unsignedBigInteger('sale_lot_residential_id')->nullable();
    ...
    {
        Schema::dropIfExists('mas_lot_residential');
    }
}
