...
class CreatePjLotBuildingOwnersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pj_lot_building_owners', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pj_lot_building_owners');
    }
}
