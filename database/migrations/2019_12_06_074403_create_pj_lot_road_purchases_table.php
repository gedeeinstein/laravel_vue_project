...
class CreatePjLotRoadPurchasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pj_lot_road_purchases', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pj_lot_road_purchase');
    }
}
