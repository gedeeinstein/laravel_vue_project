...
class CreatePjLotResidentialATable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pj_lot_residential_a', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->boolean('exists_land_residential');
            ...
            $table->bigInteger('pj_lot_residential_b_id')->unsigned()->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('pj_lot_residential_a');
    }
}
