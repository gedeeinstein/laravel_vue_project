<div class="card-subheader01 row align-items-center mx-0">
    ...
    <div class="col-4">
        <div class="form-check icheck-cyan">
            <input id="exists_land_residential" class="form-check-input" type="checkbox" :checked="residentials.active"
                :disabled="residentials.disable_input">
    ...
    <table class="table table-bordered table-small table-parcel-list border-bottom-0 mb-0 mt-0">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <div v-if="data.parcel_city == -1" class="form-group">
                        <input v-model="data.parcel_city_extra" class="form-control form-control-w-xl form-control-sm"
                            type="text" placeholder="その他市区町村" :disabled="residentials.disable_input">
                    </div>
                    <!-- parcel_town -->
                    <div class="form-group">
                        <input v-model="data.parcel_town" class="form-control form-control-w-xl form-control-sm"
                            type="text" placeholder="町域" :disabled="residentials.disable_input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <template>
                            <currency-input v-model="data.parcel_number_first"
                                ...
                                :disabled="residentials.disable_input" :currency="null" :precision="{ min: 0, max: 4 }"
                ...
                <td>
                    <template v-for="(owner, index) in data.residential_owners">
                        <div class="form-group d-flex align-items-center">
                            ...
                            <select v-model="owner.pj_property_owners_id"
                                ...
                                :class="'residential-owners-'+table" :disabled="residentials.disable_input">
                                <option value=""></option>
                            ...
                            <template>
                                <currency-input v-model.number="owner.share_denom"
                                    ...
                                    :disabled="residentials.disable_input" :currency="null"
            ...
            <tr class="d-flex align-items-stretch">
                <td class="parcel_risk">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select v-model="data.residential_b.fire_protection"
                                    class="form-control form-control-sm"
                                    :disabled="data.residential_b.fire_protection_same == 1"
                            ...
                            <div class="form-check icheck-cyan">
                                <input v-model="data.residential_b.fire_protection_same"
                                       @change="sameAsBasicResidential(data.residential_b.fire_protection_same)"
                ...
                <td class="parcel_risk">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select v-model="data.residential_b.cultural_property_reserves"
                                    class="form-control form-control-sm"
                                    :disabled="data.residential_b.cultural_property_reserves_same == 1"
                                    :disabled="!initial.editable">
                            ...
                            <div class="form-check icheck-cyan">
                                <input v-model="data.residential_b.cultural_property_reserves_same"
                                       :id="'cultural_property_reserves_same_'+table" class="form-check-input"
                                       @change="sameAsBasicResidential(data.residential_b.cultural_property_reserves_same)"
                                       type="checkbox" true-value="1" false-value="0"
                                       :disabled="!initial.editable">
                                <label class="form-check-label text-nowrap"
                                       :for="'cultural_property_reserves_same_'+table">基本と同じ</label>
                            </div>
                            <input v-model="data.residential_b.cultural_property_reserves_name"
                                   v-if="data.residential_b.cultural_property_reserves == 1"
                                   class="form-control form-control-sm" type="text" placeholder="遺跡名"
                                   :disabled="!initial.editable || data.residential_b.cultural_property_reserves_same == 1">
                        </div>
                ...
                <td class="parcel_risk">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select v-model="data.residential_b.district_planning"
                                    class="form-control form-control-sm"
                                    :disabled="data.residential_b.district_planning_same == 1"
                                    :disabled="!initial.editable">
                                <option value="3">未確認</option>
                                <option value="2">NO</option>
                                <option value="1">YES</option>
                            ...
                            <div class="form-check icheck-cyan">
                                <input v-model="data.residential_b.district_planning_same"
                                       @change="sameAsBasicResidential(data.residential_b.district_planning_same)"
                            ...
                            <input v-model="data.residential_b.district_planning_name"
                                   v-if="data.residential_b.district_planning == 1"
                                   class="form-control form-control-sm" type="text" placeholder="地区名"
                                   :disabled="!initial.editable || data.residential_b.district_planning_same == 1">
                        </div>
                ...
                <td class="parcel_risk">
                    <div class="form-group row">
                        ...
                        <!-- start - scenic_area -->
                        <div class="col-8">
                            <select v-model="data.residential_b.scenic_area"
                                    class="form-control form-control-sm"
                                    :disabled="data.residential_b.scenic_area_same == 1"
                                    :disabled="!initial.editable">
                                <option value="3">未確認</option>
                                <option value="2">NO</option>
                                <option value="1">YES</option>
                            ...
                            <div class="form-check icheck-cyan">
                                <input v-model="data.residential_b.scenic_area_same"
                                       @change="sameAsBasicResidential(data.residential_b.scenic_area_same)"
                ...
                <td class="parcel_risk">
                    <div class="form-group row">
                        ...
                        <!-- start - landslide -->
                        <div class="col-8">
                            <select v-model="data.residential_b.landslide"
                                    class="form-control form-control-sm"
                                    :disabled="data.residential_b.landslide_same == 1"
                                    :disabled="!initial.editable">
                                <option value="3">未確認</option>
                                <option value="2">NO</option>
                                <option value="1">YES</option>
                            ...
                            <div class="form-check icheck-cyan">
                                <input v-model="data.residential_b.landslide_same"
                                       @change="sameAsBasicResidential(data.residential_b.landslide_same)"
                ...
                <td class="parcel_risk">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select v-model="data.residential_b.residential_land_development"
                                    class="form-control form-control-sm"
                                    :disabled="data.residential_b.residential_land_development_same == 1"
                                    :disabled="!initial.editable">
                                <option value="3">未確認</option>
                                <option value="2">NO</option>
                                <option value="1">YES</option>
                            ...
                            <div class="form-check icheck-cyan">
                                <input v-model="data.residential_b.residential_land_development_same"
                                       @change="sameAsBasicResidential(data.residential_b.residential_land_development_same)"
