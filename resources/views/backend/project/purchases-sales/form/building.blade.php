<template v-if="buildings.data.length > 0">
    <div class="card-subheader01 row align-items-center mx-0">
        <div class="col-12 my-2">
            <div class="form-check icheck-cyan d-inline">
                <input id="exists_building_residential" class="form-check-input" type="checkbox" checked="checked"
                    disabled="disabled">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <!-- building_usetype -->
                                <input :value="master_values[field.building_usetype]" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="町域" readonly>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group icheck-cyan mx-2">
                                ...
                                <input v-model="field.building_attached" type="checkbox"
                                    id="building_attached" :value="1" disabled>
                                <label for="building_attached">有</label>
                            </div>
                            <div v-if="field.building_attached == 1" class="form-group">
                                <!-- building_attached_select -->
                                <input v-if="field.building_attached_select == 1" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="車庫" readonly>
                                <input v-else-if="field.building_attached_select == 2" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="倉庫" readonly>
                                <input v-else-if="field.building_attached_select == 3" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="納屋" readonly>
                                <input v-else-if="field.building_attached_select == 4" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="物置 " readonly>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group d-flex align-items-center mx-n1">
                                ...
                                <select v-model="field.building_date_nengou" id="date-nengou"
                                    readonly class="form-control form-control-w-ms form-control-sm mx-1">
                                ...
                                <span>年</span>
                                <input v-model="field.building_date_month" readonly
                                    class="form-control form-control-w-xs form-control-sm mx-1" type="tel">
                                </span>
                                <span>月</span>
                                <!-- building_date_day -->
                                <span>
                                <input v-model="field.building_date_day" readonly
                                    class="form-control form-control-w-xs form-control-sm mx-1" type="tel">
                                </span>
                                <span>日</span>
                            </div>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="form-group row mx-n1">
                                <div class="col-6 px-1">
                                    <!-- building_structure -->
                                    <input :value="master_values[field.building_structure]" class="form-control form-control-sm mx-1"
                                        type="text" placeholder="町域" readonly>
                                </div>
                                <div class="col-3 px-1">
                                    <!-- building_floor_count -->
                                    <input v-model="field.building_floor_count" class="form-control form-control-sm mx-1" type="tel" readonly>
                                </div>
                        ...
                        <td>
                            <div class="form-group">
                                <!-- building_roof -->
                                <input :value="master_values[field.building_roof]" class="form-control form-control-sm"
                                    type="text" placeholder="町域" readonly>
                            </div>
                        </td>
                        <td>
