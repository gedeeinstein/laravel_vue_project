<template v-if="residentials.data.length > 0">
    <div class="card-subheader01 row align-items-center mx-0">
        <div class="col-4">
            <div class="form-check icheck-cyan">
                <input id="exists_land_residential" class="form-check-input" type="checkbox" checked="checked"
                    disabled="disabled">
    ...
    <div class="table-whole-hover">
        ...
        <table id="residential-table" class="table table-hover table-bordered table-small table-parcel-list">
            ...
            <tbody>
                <template v-for="(field, row) in residentials.data">
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <input v-model="master_values[field.parcel_land_category]" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="その他市区町村" readonly>
                            </div>
                        </td>
                        ...
                        <td>
                            <div v-for="(use_districts, index) in field.use_districts" v-show="!use_districts.deleted" class="form-group">
                                <input v-model="master_values[use_districts.value]" class="form-control form-control-w-xl form-control-sm"
                                    type="text" placeholder="その他市区町村" readonly>
                            </div>
                        </td>
                        ...
                        <td>
                            <template v-for="(owner, index) in field.residential_owners" v-if="!owner.deleted">
                                <div class="form-group d-flex align-items-center mx-n1">
                                    <input v-model="property_owners[owner.pj_property_owners_id]" class="form-control form-control-w-lg form-control-sm mx-1"
                                        type="text" placeholder="その他市区町村" readonly>
                                    <!-- share_denom -->
                                    <template>
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="form-group row">
                                ...
                                <select v-model="field.residential_purchase.urbanization_area" class="form-control form-control-sm" data-id="A62-1"
                                    :disabled="field.residential_purchase.urbanization_area_same == 1 || !initial.editable">
                                ...
                                <template v-if="field.residential_purchase.urbanization_area == 3">
                                    <label for="" class="col-form-label pl-4 pr-4">土地区画整理事業</label>
                                    <select v-model="field.residential_purchase.urbanization_area_sub" class="form-control form-control-w-md form-control-sm" data-id="A62-2"
                                        :disabled="field.residential_purchase.urbanization_area_same == 1 || !initial.editable">
                                        <option value="1">保留地</option>
                                        <option value="2">仮換地</option>
                                    </select>
                                    <input v-model="field.residential_purchase.urbanization_area_number" class="form-control form-control-w-md ml-1 form-control-sm"
                                    ...
                                    <date-picker v-model="field.residential_purchase.urbanization_area_date" type="date" name="" input-class="form-control form-control-sm input-date w-100" value-type="format" format="YYYY/MM/DD"
                                        :disabled="field.residential_purchase.urbanization_area_same == 1 || !initial.editable" data-id="A62-4">
                                    </date-picker>
                                </template>
                                <div class="form-check icheck-cyan d-inline mt-1 ml-4">
                                    <input :id="'urbanization_area_same_residential'+row" v-model="field.residential_purchase.urbanization_area_same" class="form-check-input" type="checkbox" name="" value="1" :disabled="!initial.editable" data-id="A62-5">
                                    <label class="form-check-label" :for="'urbanization_area_same_residential'+row">基本と同じ</label>
                                </div>
                            </div>
                        </td>
                    </tr>
