...
<div class="form-group">
    <table class="table table-bordered table-small-x table-expense-list mt-0">
        ...
        <template v-for="data in sections.f.data">
    ...
    <table class="table table-bordered table-small-x mt-0 w-auto">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <!-- total_budget -->
                    <input :value="total_f.budget | numeralFormat" class="form-control form-control-sm" type="text" readonly="readonly">
                </td>
                <td>
                    <!-- total_decided -->
                    <input :value="total_f.decided | numeralFormat" class="form-control form-control-sm" type="text" readonly="readonly">
                </td>
                <td>
                    <!-- total_paid -->
                    <input :value="total_f.paid | numeralFormat" class="form-control form-control-sm" type="text" readonly="readonly">
                </td>
                <td>
                    <!-- total_balance -->
                    <input :value="total_f.balance | numeralFormat" class="form-control form-control-sm" :class="{'bg-orange-expense': (total_f.balance != 0)}" type="text" readonly="readonly">
                </td>
            </tr>
            <tr>
                <td>消費税小計</td>
                <td>
                    <!-- total_budget_tax -->
                    <input :value="total_f.budget_tax | numeralFormat" class="form-control form-control-sm" type="text" readonly="readonly">
                </td>
                <td>
                    <!-- total_decided_tax -->
                    <input :value="total_f.decided_tax | numeralFormat" class="form-control form-control-sm" type="text" readonly="readonly">
                </td>
                <td>
                    <!-- total_paid_tax -->
                    <input :value="total_f.paid_tax | numeralFormat" class="form-control form-control-sm" type="text" readonly="readonly">
                </td>
                <td>
                    <!-- total_balance_tax -->
                    <input :value="total_f.balance_tax | numeralFormat" class="form-control form-control-sm" :class="{'bg-orange-expense': (total_f.balance_tax != 0)}" type="text" readonly="readonly">
                </td>
            </tr>
        </tbody>
    </table>
