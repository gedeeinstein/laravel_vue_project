...
@section('top_buttons')
    @if ($page_type == "create")
        <a href="{{route('admin.superadmin.index')}}" class="btn btn-info float-sm-right">@lang('label.list')</a>
    @else
        <a href="{{route('admin.superadmin.create')}}" class="btn btn-info float-sm-right">@lang('label.createNew')</a>
        <a href="{{route('admin.superadmin.index')}}" class="btn btn-info float-sm-right">@lang('label.list')</a>
    @endif
@endsection
