...
{{--              <input v-model="item.password" type="password" id="input-password" name="password" class="form-control @error('password') is-invalid @enderror" :required="true" data-parsley-minlength="8" />--}}
{{--          </div>--}}
{{--      </div>--}}
{{--  @else--}}
{{--      <div id="form-group--password" class="row form-group">--}}
