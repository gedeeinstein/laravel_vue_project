<script type="text/x-template" id="project-memo">
    <li class="my-2 memo-entry" :class="{ 'text-black-50': entry.is_deleted, 'create': entry.create, 'edit': entry.edit }">
        <div class="row mx-n2">
                    ...
                    <template v-else>
                        ...
                        <template v-if="entry.content">
                            <div class="px-1 col-auto">
                                <span v-if="entry.is_deleted"><s>@{{ entry.content }}</s></span>
                        ...
                        <template v-if="timestamp">
                            <div class="px-1 col-auto d-flex align-items-center">
                                <span class="fs-12" v-if="entry.is_deleted"><s>@{{ timestamp }}</s></span>
                        ...
                        <template v-if="entry.user && entry.user.full_name">
                            <div class="px-1 col-auto">
                                <span class="fs-12" v-if="entry.is_deleted"><s>@{{ entry.user.full_name }}</s></span>
            ...
            <template v-if="editMode && !entry.edit && !entry.create && !entry.is_deleted">
