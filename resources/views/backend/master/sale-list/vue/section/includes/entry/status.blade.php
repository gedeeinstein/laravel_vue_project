<div class="row mx-0 bg-light">
    ...
    <div class="px-1 column col-md col-lg-auto d-flex align-items-center">
            ...
            <div class="row mx-n1 justify-content-center flex-lg-nowrap">
                ...
                <div class="px-1 col-6 col-sm-4 col-md col-lg-90px mb-2 mb-md-0">
                    <div class="input-group input-group-sm" v-for="id in [ 'section-' +entry.id+ '-sale-net' ]">
                        ...
                        <select :name="id" :id="id" class="form-control p-1" v-model.number="saleNet">
                ...
                <div class="px-1 col-6 col-sm-4 col-md col-lg-90px mb-2 mb-md-0">
                    <div class="input-group input-group-sm" v-for="id in [ 'section-' +entry.id+ '-sale-mediation' ]">
                        ...
                        <select :name="id" :id="id" class="form-control p-1" v-model.number="saleMediation">
                            <option value="0">未選択</option>
                            <option value="1">〇</option>
                            <option value="2">×</option>
                        </select>
                ...
                <div class="px-1 col-6 col-sm-4 col-md col-lg-90px mb-2 mb-md-0">
                    <div class="input-group input-group-sm" v-for="id in [ 'section-' +entry.id+ '-sale-condition' ]">
                        ...
                        <select :name="id" :id="id" class="form-control p-1" v-model.number="saleCondition">
                            <option value="0">未選択</option>
                ...
                <div class="px-1 col-6 col-sm-4 col-md col-lg-90px mb-2 mb-md-0">
                    <div class="input-group input-group-sm" v-for="id in [ 'section-' +entry.id+ '-sale-signboard' ]">
                        ...
                        <select :name="id" :id="id" class="form-control p-1" v-model.number="saleSignboard">
                            <option value="0">未選択</option>
                ...
                <div class="px-1 col-6 col-sm-4 col-md col-lg-90px mb-2 mb-md-0">
                    <div class="input-group input-group-sm" v-for="id in [ 'section-' +entry.id+ '-sale-rank' ]">
                        ...
                        <select :name="id" :id="id" class="form-control p-1" v-model.number="saleRank">
                ...
                <div class="px-1 col-6 col-sm-4 col-md col-lg-70px mb-2 mb-md-0">
                    <!-- Toggle edit memo button - Start -->
                    <div class="px-1 col-sm col-lg-auto" @click="toggleEditMemo">
                        <button type="button" class="btn btn-block btn-sm px-2 btn-info">
                            <span>更新</span>
                        </button>
                    </div>
